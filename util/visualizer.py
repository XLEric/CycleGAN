...
def display_results(opt,visuals, epoch, save_result):
    ...
    """
    if opt.display_id > 0:  # show images in the browser using visdom
        ncols = opt.display_ncols
        if ncols > 0:        # show all the images in one visdom panel
            ...
            for i in range(len(images)):
                ...
                if stack_n is not None:
                    stack_n = np.hstack((stack_n,img_))
